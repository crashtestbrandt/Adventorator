...
class TestManifestValidation:
    ...
    def test_validate_content_hashes_tampered_fixture(self):
        ...
        assert any("entities/npc.json" in error for error in errors), f"Expected npc.json hash error, got: {errors}"
    ...
    def test_validate_content_hashes_missing_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            manifest = {
                "content_index": {
                    "missing.txt": "abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890"
                }
            }
