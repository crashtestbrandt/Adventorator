        ...
        test_cases = [
            {
                ...
                "chunk": LoreChunk(
                    ...
                    provenance={
                        ...
                        "manifest_hash": "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",  # noqa: E501
                    },
                ),
            ...
            },
            {
                ...
                "chunk": LoreChunk(
                    ...
                    content=(
                        ...
                        "of our chunking algorithm. It should produce a stable hash regardless "
                        "of the complexity."
                    ),
                    ...
                    provenance={
                        "package_id": TEST_PACKAGE_ID,
                        "manifest_hash": "fedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210",  # noqa: E501
                    },
...
"""
        ...
        for i, (chunk1, chunk2) in enumerate(zip(chunks1, chunks2, strict=True)):
        ...
        for i, (event1, event2) in enumerate(zip(events1, events2, strict=True)):
