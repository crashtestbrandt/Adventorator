...
class TestCompleteImportWorkflow:
    ...
    def test_manifest_to_entity_pipeline(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                # Manifest validation can fail when fixtures omit supporting artifacts.
                # That behavior is expected in a few scenarios, so fall back to fixture defaults.
    ...
    def test_feature_flag_disabled_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # All phases should respect feature flag
            ...
            try:
                manifest_phase.validate_and_register(
                    package_root / "package.manifest.json", package_root
                )
                raise AssertionError("Manifest phase should not run when feature flag disabled")
            except Exception as e:
